...
certutil -addstore "Root" nginx\ssl\cert.pem
```
...
#### Linux:
```bash
sudo cp nginx/ssl/cert.pem /usr/local/share/ca-certificates/openwebui.crt
...
cp twoj-klucz.pem nginx/ssl/key.pem
